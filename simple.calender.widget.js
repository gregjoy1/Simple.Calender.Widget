var SimpleCalenderWidget = {
	...
	*/
	drawCalender:function(){
		...
		var CalenderTitleBar = document.createElement('div');
		CalenderTitleBar.className = 'calender_title_bar';

		var CalenderTitleControlGroupBar = document.createElement('div');
		...
		HeaderContainer.className = 'calender_header_container';
		...
		CalenderTitleBar.appendChild(CalenderTitleControlGroupBar);
		CalenderTitleBar.appendChild(HeaderContainer);

		// Creates calender week and day cell containers
		var MonthContainer = document.createElement('div'); 
		MonthContainer.className = 'calender_month_container';
		...
		SimpleCalenderWidget.CalenderElementCache.MainContainerCache.appendChild(CalenderTitleBar);
		SimpleCalenderWidget.CalenderElementCache.MainContainerCache.appendChild(MonthContainer);
